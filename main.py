...
def main(argv=None):
    ...
    # 健康码统计
    健康码统计字典 = {"总数": 121212, "绿码总数": 0, "黄码总数": 0, "红码总数": 0, "橙码总数": 0, "未申领健康码": 0}
    # 学生接触外省人员
    ...
    wbNEW["综合统计"].append([
        ...
        "总计", "绿码人数", "黄码人数", "红码人数","橙码人数", "未申领人数",
        "接触过省外返衢对象的(学生数)", "接触过境外返衢对象的(学生数)", "与疫情中高风险地区、境外回衢人员接触的家长人数统计",
    ])
    wbNEW["综合统计"].append([
        学校名称,乘坐公交车学生人数, 合计, 内地学生数, 港澳台学生数, 留学生, 应到人数 - 请假学生字典["总数"], 应到人数, 请假学生字典["总数"], \
        请假学生字典["因发热未到或请假"],请假学生字典["因咳嗽腹泄乏力请假人数"] + 请假学生字典["因其他原因请假人数"],\
        晨检异常字典["总数"], 晨检异常字典["体温异常"], 晨检异常字典["其他异常"],\
        健康码统计字典["总数"], 健康码统计字典["绿码总数"],健康码统计字典["黄码总数"],健康码统计字典["红码总数"],健康码统计字典["橙码总数"],健康码统计字典["未申领健康码"],\
        学生接触外省人员字典["总数"],0, 家长接触重点疫区境外字典["总数"],
    ])
    # 设置自动列宽
