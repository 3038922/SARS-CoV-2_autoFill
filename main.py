...
def main(argv=None):
    ...
    wbNEW["综合统计"].append([
        学校名称, 应到人数, 应到人数 - 请假学生字典["总数"], 请假学生字典["总数"], 请假学生字典["因发热未到或请假"], 请假学生字典["因咳嗽腹泄乏力请假人数"],
        请假学生字典["因其他原因请假人数"], 晨检异常字典["总数"], 晨检异常字典["体温异常"], 晨检异常字典["其他异常"], 晨检午检异常描述,
        学生接触外省人员字典["总数"], 家长接触重点疫区境外字典["总数"], 乘坐公交车学生人数
    ])
